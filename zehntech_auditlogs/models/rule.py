...
class AuditlogRule(models.Model):
    ...
    name = fields.Char(required=True, help="Enter the name of the audit log rule.", states={"subscribed": [("readonly", True)]})
    ...
    def create(self, vals_list):
        records = super(AuditlogRule, self).create(vals_list)
        records._patch_methods()
        return records

    def write(self, vals):
        result = super(AuditlogRule, self).write(vals)
        self._patch_methods()
        return result
